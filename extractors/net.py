                ...
                try:
                    ...
                    try:
                        if post_data and isinstance(post_data, dict):
                            r = cffi_client.post(url, data=post_data, headers=cf_headers, impersonate="chrome120", timeout=30)
                        else:
                            r = cffi_client.get(url, headers=cf_headers, impersonate="chrome120", timeout=30)
                    except TypeError:
                        if post_data and isinstance(post_data, dict):
                            r = cffi_client.post(url, data=post_data, headers=cf_headers, timeout=30)
                        else:
